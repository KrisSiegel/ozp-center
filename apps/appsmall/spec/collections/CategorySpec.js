/*
 * Category colletion test suite.
 */
describe("Category Collection", function() {

    describe("when fetched", function() {
        
        // Dummy data which is used to fake a server response
        var APP_COLLECTION = getJSONFixture('collections/Categories.json');
        ...
        beforeEach(function() {
            ...
            this.collection = new AppsMall.Collections.Category();
