/*
 * Grouping colletion test suite.
 */
describe("Grouping Collection", function() {

    describe("when fetched", function() {
        
        // Dummy data which is used to fake a server response
        var APP_COLLECTION = getJSONFixture('collections/Groupings.json');
        ...
        beforeEach(function() {
            ...
            this.collection = new AppsMall.Collections.Grouping();
