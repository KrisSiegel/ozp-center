...
controllersModule.controller('AppSubmissionController',  ['$scope', '$rootScope', '$q', '$location', '$window', '$modal', 'Persona', 'AppOrComponent', 'Dropdown', 'Tag', 'AppWorkflow', 'FileUpload',
    function($scope, $rootScope, $q, $location, $window, $modal, Persona, AppOrComponent, Dropdown, Tag, AppWorkflow, FileUpload) {
