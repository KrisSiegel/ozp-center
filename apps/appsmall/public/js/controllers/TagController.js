...
controllersModule.controller('TagController', ['$rootScope', '$scope', '$q', '$timeout', 'AppOrComponent', 'Tag', 'AppSelectionMessage',
    function($rootScope, $scope, $q, $timeout, AppOrComponent, Tag, AppSelectionMessage) {
