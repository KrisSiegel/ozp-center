...
controllersModule.controller('AdminAppController', ['$scope', '$rootScope', '$window', '$q', 'AppOrComponent', 'AppWorkflow', 'Persona',
    function($scope, $rootScope, $window, $q, AppOrComponent, AppWorkflow, Persona) {
